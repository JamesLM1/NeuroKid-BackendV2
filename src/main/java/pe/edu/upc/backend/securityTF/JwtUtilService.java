...
public class JwtUtilService {
    ...
    private static final Long JWT_TOKEN_VALIDITY = 1000 * 60 * 60 * (long)3; // 3 horas de validez
    ...
    public String generateToken(UserSecurity securityUser) {
        ...
        // Mapea las authorities a una lista de Strings (ej. ["ROLE_ADMIN", "ROLE_PADRE"])
